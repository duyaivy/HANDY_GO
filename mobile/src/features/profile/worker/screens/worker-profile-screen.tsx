...
export function WorkerProfileScreen() {
  return (
    <Screen safeArea scrollable className="bg-neutral-50 dark:bg-neutral-950">
      <View testID="profile-worker-screen" className="flex-1 items-center justify-center px-6 py-12">
        ...
        <View className="mt-8 w-full rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
          ...
          <Text className="mt-2 text-sm text-neutral-700 dark:text-neutral-300">
            Thư mục:
            {' '}
            <Text className="font-semibold text-neutral-900 dark:text-white">src/features/profile/worker/</Text>
          </Text>
          <Text className="mt-1 text-sm text-neutral-700 dark:text-neutral-300">
            Người phụ trách:
            {' '}
            <Text className="font-semibold text-neutral-900 dark:text-white">Worker Profile Owner</Text>
          </Text>
          ...
          <View className="mt-4 rounded-xl bg-neutral-100 p-3 dark:bg-neutral-800">
            <Text className="text-xs/relaxed text-neutral-600 dark:text-neutral-400">
              Đây là placeholder hồ sơ của Đối tác Thợ (dữ liệu backend từ User &amp; Trust Service qua API Gateway). Thông tin tay nghề, chứng chỉ, điểm đánh giá uy tín, tài khoản thanh toán và cài đặt ca trực sẽ được phát triển tại đây.
            </Text>
          </View>
        </View>
      </View>
